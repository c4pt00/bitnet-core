...
static constexpr unsigned int DEFAULT_BLOCK_MIN_TX_FEE{10};
...
static constexpr unsigned int MIN_STANDARD_TX_NONWITNESS_SIZE{10};
...
static constexpr unsigned int DUST_RELAY_TX_FEE{10};
